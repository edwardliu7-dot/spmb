...
export const pendaftarTable = pgTable("pendaftar", {
  ...
  riwayat_penyakit: text("riwayat_penyakit").notNull(),
  transportasi: text("transportasi").notNull(),
  jarak_sekolah: text("jarak_sekolah").notNull(),
  nama_sekolah_asal: text("nama_sekolah_asal").notNull(),
  tahun_lulus: integer("tahun_lulus").notNull(),
  alamat_sekolah_asal: text("alamat_sekolah_asal").notNull(),
  nomor_kk: text("nomor_kk").notNull(),
  nik_orangtua: text("nik_orangtua").notNull(),
  ...
  nama_wali: text("nama_wali").notNull(),
  hubungan_wali: text("hubungan_wali").notNull(),
